...
// die();
// C:\OpenServer\domains\ik-word\wordpress\wp-content\plugins\lifts-examination\protokol/

// require get_template_directory() . '/protokol/tfpdf/tfpdf.php';
require plugin_dir_path( __DIR__ ) . 'tfpdf/tfpdf.php';

// require get_template_directory() . '/protokol/variables.php';
require plugin_dir_path( __DIR__ ) . 'variables.php';

// require get_template_directory() . '/protokol/functions.php';
require plugin_dir_path( __DIR__ ) . 'functions.php';


// require get_template_directory() . '/protokol/data/lifti.php';
// require get_template_directory() . '/protokol/data/valditaji.php';
// require get_template_directory() . '/protokol/data/parbaudes.php';

// require get_template_directory() . '/protokol/fonts.php';
...
$pdf->AddFont( 'Georgia Italic', '', 'Georgiai.ttf', true );
$pdf->AddFont( 'Georgia Bold', '', 'Georgiab.ttf', true );
$pdf->AddFont( 'Georgia Bold Italic', '', 'Georgiaz.ttf', true );
$pdf->AddFont( 'FiraMono', '', 'FiraMono-Regular.ttf', true );
$pdf->AddFont( 'FiraMono Medium', '', 'FiraMono-Medium.ttf', true );
$pdf->AddFont( 'FiraMono Bold', '', 'FiraMono-Bold.ttf', true );
...
$is_atkartota = 'atkartota' === $parbaude_veids;
...
$lifts_parbaudes_adrese       = $lifts_parbaudes_adrese_short . ', ' . ( $lifts_adrese_pilseta ? $lifts_adrese_pilseta : 'Rīga' ) . ', ' . $lifts_adrese_indeks;
...
if ( $headless ) {
	...
	// require_once get_template_directory() . '/protokol/header.php';
	require plugin_dir_path( __DIR__ ) . 'header.php';
}
// headless
...
// $pdf->Image( get_template_directory() . '/protokol/img/latak_logo.jpg', $width - 5, 30, 22, );
$pdf->Image( plugin_dir_path( __DIR__ ) . 'img/latak_logo.jpg', $width - 5, 30, 22, );
...
$pdf->cell( $parbaudes_veids_3col_width, $parbaudes_veids_cell_height, $parbaude_veids === 'pirmreizeja' ? 'X' : '', 1, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
$pdf->cell( $parbaudes_veids_4col_width, $parbaudes_veids_cell_height, 'Kārtējā', 0, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
$pdf->cell( $parbaudes_veids_5col_width, $parbaudes_veids_cell_height, $parbaude_veids === 'karteja' ? 'X' : '', 1, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
$pdf->cell( $parbaudes_veids_6col_width, $parbaudes_veids_cell_height, 'Ārpuskārtas', 0, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
$pdf->cell( $parbaudes_veids_7col_width, $parbaudes_veids_cell_height, $parbaude_veids === 'arpuskartas' ? 'X' : '', 1, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
$pdf->cell( $parbaudes_veids_8col_width, $parbaudes_veids_cell_height, 'Atkārtotā', 0, 0, 'C', false );
$pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
$pdf->cell( $parbaudes_veids_9col_width, $parbaudes_veids_cell_height, $parbaude_veids === 'atkartota' ? 'X' : '', 1, 1, 'C', false );
...
$pdf->cell( $iekarta_marketa_2col_width, 5, $parbaude_zimes_nr, 'B', 0, 'C', false );
...
if ( $digitally_signed ) {
	...
	$pdf->cell( $iekarta_marketa_6col_width + 18, 5, $eksperts, 0, 1, 'L', false );
} else {
	$pdf->cell( $iekarta_marketa_4col_width, 5, 'Eksperts ', 0, 0, 'L', false );
	$pdf->cell( $iekarta_marketa_5col_width, 5, '', 'B', 0, 'R', false );
	$pdf->cell( $iekarta_marketa_6col_width, 5, $eksperts, 0, 1, 'L', false );
}
...
if ( 'atkartota' !== $parbaude_veids && $valditajs_protokols_ar_merijumiem ) {
	...
	$pdf->cell( 45, 5, $eksperts, 'B', 1, 'C', false );
	...
	foreach ( $checkboxes as $checkbox ) {
		// $pdf->Image( get_template_directory() . '/protokol/img/checkbox.png', $checkbox['x'] + $el_merijumi_second_table_col_data_width / 2 - $checkbox_image_width / 2, $checkbox['y'], $checkbox_image_width, $checkbox_image_height, );
		$pdf->Image( plugin_dir_path( __DIR__ ) . 'img/checkbox.png', $checkbox['x'] + $el_merijumi_second_table_col_data_width / 2 - $checkbox_image_width / 2, $checkbox['y'], $checkbox_image_width, $checkbox_image_height, );
	}
	foreach ( $empty_checkboxes as $empty_checkbox ) {
		// $pdf->Image( get_template_directory() . '/protokol/img/empty_checkbox.png', $empty_checkbox['x'] + $el_merijumi_second_table_col_data_width / 2 - $checkbox_image_width / 2, $empty_checkbox['y'], $checkbox_image_width, $checkbox_image_height, );
		$pdf->Image( plugin_dir_path( __DIR__ ) . 'img/empty_checkbox.png', $empty_checkbox['x'] + $el_merijumi_second_table_col_data_width / 2 - $checkbox_image_width / 2, $empty_checkbox['y'], $checkbox_image_width, $checkbox_image_height, );
	}
	// var_dump($checkboxes);
